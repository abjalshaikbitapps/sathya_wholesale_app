        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate>
          ...
          <div className="my-5 flex flex-wrap sm:my-8">
            ...
            <Card className="w-full sm:w-8/12 md:w-2/3">
              ...
              <Input
                label={`${t('form:input-label-buyingprice')}`}
              ...
              <Input
                label={`${t('form:input-label-statetax')}`}
                {...register('statetax')}
                error={t(errors.name?.message!)}
                variant="outline"
                className="mb-5"
              ...
              <Input
                label={`${t('form:input-label-countrytax')}`}
                {...register('countrytax')}
                error={t(errors.name?.message!)}
                variant="outline"
                className="mb-5"
              ...
              <Input
                label={`${t('form:input-label-localtax')}`}
                {...register('localtax')}
                error={t(errors.name?.message!)}
                variant="outline"
                className="mb-5"
              ...
              <TextArea
                label={t('form:input-label-itemshortdescription')}
