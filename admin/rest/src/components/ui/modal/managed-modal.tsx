...
const CustomerView = dynamic(
  () => import('@/components/user/user-view')
);
...
const UserDeleteView = dynamic(
  () => import('@/components/user/delete-user-view')
);
const ThreeplDeleteView = dynamic(
  () => import('@/components/threepl/delete-threepl-view')
);
