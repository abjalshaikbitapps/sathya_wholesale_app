export const API_ENDPOINTS = {
  ...
  ANALYTICS: 'analytics',
  ANALYTICSYEAR: 'analyticYear',
  ANALYTICSMONTH:  'analyticMonth',
  ANALYTICSWEEK:   'analyticWeek',
  ANALYTICSTODAY:   'analytictoday',
  ANALAYTICSDATERANGE:'analyticDaterangepicker',
