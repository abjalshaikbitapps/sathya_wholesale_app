...
import { useVerifyMutation } from '@/data/user';

export default function UpdateVerifyPage() {
  const { query, locale } = useRouter();
  const { t } = useTranslation();
  const slugval=query.action as string;
  console.log(slugval,"uservalu");
  ...
  //   error,
  // } = useCategoryQuery({
  //   slug: query.verifyslug as string,
  //   language:
