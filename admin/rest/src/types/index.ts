...
export interface User {
  ...
  tobacco_license:string;
  business_license_verify:number;
  tobacco_license_verify:number;
  permissions:any[];
  phone_number:string;
  Role:any;
}
...
export interface UpdateUser {
  ...
  tobaccoLicenseVerify?:number;
  tobaccoLicenseReason?:string;
  deletedDate?:any;
  permission:string;
}
...
export interface TplQueryOptions extends QueryOptions {
  name: string;
}
...
export interface TplPaginator extends PaginatorInfo<Tpl> {}
