...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password', 'is_active', 'shop_id', 'phone_number', 'business_license','tobacco_license', 'is_age_above_18', 'business_license_verify', 'tobacco_license_verify','business_license_reason', 'tobacco_license_reason', 'deletedBy', 'deleteddate', 'Role'
    ];
