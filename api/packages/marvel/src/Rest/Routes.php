...
use Marvel\Http\Controllers\ThreelpController;
...
Route::post('/threelp', [ThreelpController::class,'threelp']);

Route::get('/tpl/list', [ThreelpController::class, 'treepllist']);
Route::get('/categorylist', [ThreelpController::class, 'selectedcategory']);
Route::get('/searchproduct/{id}', [ProductController::class, 'productsearch']);

Route::apiResource('threepl', ThreelpController::class);

Route::put('threepl/{id}', [ThreelpController::class, 'update']);
Route::delete('threepl/{id}', [ThreelpController::class, 'destroy']);
...
Route::post('variation-products', [ProductController::class, 'variationProducts']);
...
Route::group(
    ...
    function () {
        ...
        Route::get('analyticYear', [AnalyticsController::class, 'analyticYear']);
        Route::get('analyticMonth', [AnalyticsController::class, 'analyticMonth']);
        Route::get('analyticWeek', [AnalyticsController::class, 'analyticWeek']);
        Route::get('analytictoday', [AnalyticsController::class, 'analytictoday']);
        Route::get('analytics', [AnalyticsController::class, 'analytics']);
        Route::get('analyticDaterangepicker', [AnalyticsController::class, 'analyticDaterangepicker']);
...
Route::group(
    ...
    function () {
        ...
        Route::get('/customer/list', [UserController::class, 'customers']);
        Route::get('/users/list', [UserController::class, 'users']);
    }
);
